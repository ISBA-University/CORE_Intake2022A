...
# Preisbildung, Kosten und Zahlungsbereitschaft

```{r,echo=FALSE}
knitr::include_url('https://www.tagesschau.de/wirtschaft/verbraucher/strompreis-preisbildung-101.html',height="550px")
```
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('../images/unit08/AT-NE_Bofinger_S46.png',height='480px')
```
]
]
...
<iframe src="https://www.npr.org/player/embed/1154775118/1155543493" width="100%" height="500" frameborder="0" scrolling="no" title="NPR embedded audio player"></iframe>
